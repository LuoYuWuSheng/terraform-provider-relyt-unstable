		...
		Attributes: map[string]schema.Attribute{
			...
			"data_access_config": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"endpoint":       schema.StringAttribute{Required: true, Description: "The DNS name of the VPC endpoint for the private link. Usually the schema is protocol:[//host[:port]].eg: http://your-host:8180"},
					"client_timeout": schema.Int32Attribute{Optional: true, Description: "data access client timeout seconds!"},
				},
			},
		},
	}
